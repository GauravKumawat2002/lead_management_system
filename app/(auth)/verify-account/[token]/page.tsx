  ...
  return (
    <Card className="base-form-width flex flex-col items-center text-center">
      <CardHeader className="relative mb-6 w-full">
        ...
        <CircleCheck className="z-10 mx-auto h-16 w-16 text-primary-foreground" />
        <CardTitle className="z-10 text-3xl tracking-wider text-primary-foreground">
          Email is Verified!
        </CardTitle>
      </CardHeader>
      ...
      <CardContent className="text-gray-700 dark:text-gray-200">
        <CardDescription>
          Your E-mail has been successfully verified. You can now go back to the
          login page to access the{" "}
